...
public class InventoryManager : MonoBehaviour
{
	...
	public static ActionBar actionBar
	{
		get
		{
			Debug.Log (Instance.allInventoryObjects.Find (x => x is ActionBar));
			return Instance.allInventoryObjects.Find (x => x is ActionBar) as ActionBar;
		}
	}
	public static Inventory inventory
	{
		get
		{
			return Instance.allInventoryObjects.Find (x => x is Inventory) as Inventory;
		}
	}
